    ...
    public function store(Request $request)
    {
		...
		if ($user_auth->can('user_add')){
            ...
            $request->validate([
                ...
                'role_users_id'    => 'required|exists:roles,id', // Ensure the role exists
            ]);
            ...
            \DB::transaction(function () use ($request) {
                ...
                // Retrieve the role name by its ID
                $roleName = \Spatie\Permission\Models\Role::findById($request['role_users_id'])->name;
