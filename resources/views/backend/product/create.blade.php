...
<section class="forms">
            ...
            <div class="modal-body">
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        <label>{{ __('Meta Title') }}</label>
                        <input type="text" name="page_title" required class="form-control" placeholder="Meta Title...">
                    </div>
                    <div class="col-md-12 form-group">
                        <label>{{ __('Meta Description') }}</label>
                        <input type="text" name="short_description" class="form-control" placeholder="Meta Description...">
                    </div>
                </div>
                @endif
                <div class="form-group">
    ...
    <div id="addTax" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('tax.store') }}" method="post" id="tax-form">
                    @csrf
                    @method('POST')
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="rate" value="{{ old('rate') }}" required class="form-control" step="any">
                        </div>
                        <input type="hidden" name="ajax" value="1">
