...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    ...
    <form action="{{ route('category.update', 1) }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <input type="text" name="page_title" value="{{ old('page_title') }}" required class="form-control" placeholder="Meta Title...">
                </div>
                <div class="col-md-12 form-group">
                    <label>{{ __('Meta Description') }}</label>
                    <input type="text" name="short_description" value="{{ old('short_description') }}" required class="form-control" placeholder="Short Description...">
                </div>
            </div>
            @endif
