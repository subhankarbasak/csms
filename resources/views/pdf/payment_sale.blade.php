         ...
         <div id="client">
            <table class="table-sm">
               ...
               <tbody>
                  <tr>
                     <td>
                        <div><strong>{{ __('translate.Name') }} </strong> {{$payment['client_name']}}</div>
                        <div><strong>{{ __('translate.Phone') }} </strong>  {{$payment['client_phone']}}</div>
                        <div><strong>{{ __('translate.Address') }} </strong> {{$payment['client_adr']}}</div>
                        <div><strong>{{ __('translate.Email') }} </strong>  {{$payment['client_email']}}</div>  
                     </td>
                  </tr>
               </tbody>
            </table>
